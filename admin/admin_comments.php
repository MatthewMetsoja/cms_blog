...
<div class="text text-danger text-center"> <?php echo $error_msg ?> </div>
  <div class="row">
    ...
    <div class="col-sm-12 col-md-7">
        ...
        <div class="col-xs-12">
          ...
          <table class="table table-bordered table-hover">
              ...
              <tbody>
                  <?php 
                  $query = "SELECT * FROM comments LEFT join posts ON post_id = comment_post_id ";
                  ...
                  while($row = mysqli_fetch_assoc($result))
                  {
                      ...
                      $relating_to_post = $row['post_title'];
